...
if __name__ == "__main__":
    ...
    parser.add_argument("--action_dimensions", type=int, default=3, help="The number of actions to choose from in the action space. Default is 15.")
    ...
    parser.add_argument("--swarm_obs_interval_length", type=int, default=230, help="The number of observations per episode conducted in the swarm. Ex) Particle Best Replacement Counts are averaged over the last _ observations before an episode terminates and action is decided. Default is 30.")
    ...
    parser.add_argument("--priority_replay", type=bool, default=True, help="To use a priority replay buffer for training")
