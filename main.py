...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_actions", type=int, default=150, help="The number of actions to choose from in the action space. Default is 5.")
    parser.add_argument("--action_dimensions", type=int, default=150, help="The number of actions to choose from in the action space. Default is 15.")
