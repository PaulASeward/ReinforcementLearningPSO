...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_actions", type=int, default=21, help="The number of actions to choose from in the action space. Default is 5.")
    ...
    parser.add_argument("--save_models", type=bool, default=False, help="Whether to save the models")
    parser.add_argument("--save_buffer", type=bool, default=False, help="Whether to save the experience buffer")
