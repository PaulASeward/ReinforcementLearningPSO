...
```bash
tensorboard --logdir /home/paul/UPEI/ReinforcementLearningPSO/results --port 2223 &

python /home/paul/UPEI/ReinforcementLearningPSO/agents/ddpg_agent2.py \
  --root_dir=/home/paul/UPEI/ReinforcementLearningPSO/environment/gym_env_continuous \
  --num_iterations=2000 \
  --alsologtostderr
```
"""
...
def train_eval(
    root_dir,
    env_name='ContinuousPsoGymEnv-v0',
    eval_env_name=None,
