...
class ContinuousActions:
    def __init__(self, swarm, config):
        ...
        #
        self.actual_low_limit_action_space = [10, 0.75]
        self.actual_high_limit_action_space = [190, 1.25]
        #
