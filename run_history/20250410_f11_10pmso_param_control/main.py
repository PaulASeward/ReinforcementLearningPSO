...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_subswarms", type=int, default=10, help="The number of sub swarms. Algorithm must be PMSO Default is 5.")
    parser.add_argument("--num_actions", type=int, default=30, help="The number of actions to choose from in the action space. Default is 5.")
