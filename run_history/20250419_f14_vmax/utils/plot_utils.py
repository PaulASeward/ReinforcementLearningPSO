...
def plot_average_continuous_actions_for_multiple_swarms(continuous_action_history_path, actions_values_path, standard_pso_values_path, function_min_value, action_dimensions, action_names, practical_action_low_limit, practical_action_high_limit, num_intervals=9, separate_plot_for_interval=8):
